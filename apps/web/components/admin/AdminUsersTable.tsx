...
export function AdminUsersTable() {
  ...
  async function toggleRole(u: AdminUserRow) {
    ...
    const ok = await confirm({
      title: makeAdmin ? 'Make this user an admin?' : 'Revoke admin access?',
      description: makeAdmin
        ? `${u.email} will get full access to this admin dashboard.`
  ...
  async function remove(u: AdminUserRow) {
    const ok = await confirm({
      ...
      description: `Permanently delete ${u.email} and all ${u.projectCount} of their project${u.projectCount === 1 ? '' : 's'}. This cannot be undone.`,
                    ...
                    <TableCell>
                      <div className="flex items-center justify-end gap-1.5">
                        ...
                        <Button
                          ...
                          title={isSelf ? 'You cannot delete yourself here' : 'Delete user'}
