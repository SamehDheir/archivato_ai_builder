...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      // Logical insets: the check indicator sits on the reading-leading edge, so
      // it has to flip in Arabic. `pl-8 pr-2` + `left-2` used to strand it on the
      // physical left, overlapping the RTL label.
